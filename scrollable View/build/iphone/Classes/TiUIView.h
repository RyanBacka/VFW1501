...
/**
 Base class for all scrollableView views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the scrollableView view hierarchy (such as wrapped iOS UIViews) was touched.
