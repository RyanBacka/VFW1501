...
//Rare exceptions to indicate a bug in the _scrollableview code (Eg, function that a subclass should have implemented)
...
/**
 The base class for scrollableView proxies.
 */
