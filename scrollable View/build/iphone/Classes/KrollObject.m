...
//@interface scrollableViewObject : NSObject
//@end

@interface scrollableViewObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[scrollableViewObject class]])
		{
			for (NSString *key in [[(scrollableViewObject*)o modules] allKeys])
			{
