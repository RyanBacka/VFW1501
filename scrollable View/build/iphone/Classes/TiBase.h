...
// in simulator we redefine to format for scrollableView Developer console
...
{\
	NSString * exceptionName = [@"org.scrollableview." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.scrollableview";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIscrollableViewNativeItemNone = -1, 
	UIscrollableViewNativeItemSpinner = -2,
	UIscrollableViewNativeItemProgressBar = -3,
	
	UIscrollableViewNativeItemSlider = -4,
	UIscrollableViewNativeItemSwitch = -5,
	UIscrollableViewNativeItemMultiButton = -6,
	UIscrollableViewNativeItemSegmented = -7,
	
	UIscrollableViewNativeItemTextView = -8,
	UIscrollableViewNativeItemTextField = -9,
	UIscrollableViewNativeItemSearchBar = -10,
	
	UIscrollableViewNativeItemPicker = -11,
	UIscrollableViewNativeItemDatePicker = -12,
	
	UIscrollableViewNativeItemInfoLight = -13,
	UIscrollableViewNativeItemInfoDark = -14,
	
	UIscrollableViewNativeItemDisclosure = -15,
	
	UIscrollableViewNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all scrollableView instances of
