...
@interface scrollableViewObject : KrollCoverageObject {
#else
@interface scrollableViewObject : KrollObject {
#endif
@private
...
extern NSString * scrollableView$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	scrollableViewObject *_scrollableview;
    KrollObject* console;
	BOOL shutdown;
