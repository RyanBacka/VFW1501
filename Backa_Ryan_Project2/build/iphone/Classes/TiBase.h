...
// in simulator we redefine to format for Backa_Ryan_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.backa_ryan_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.backa_ryan_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBacka_Ryan_Project2NativeItemNone = -1, 
	UIBacka_Ryan_Project2NativeItemSpinner = -2,
	UIBacka_Ryan_Project2NativeItemProgressBar = -3,
	
	UIBacka_Ryan_Project2NativeItemSlider = -4,
	UIBacka_Ryan_Project2NativeItemSwitch = -5,
	UIBacka_Ryan_Project2NativeItemMultiButton = -6,
	UIBacka_Ryan_Project2NativeItemSegmented = -7,
	
	UIBacka_Ryan_Project2NativeItemTextView = -8,
	UIBacka_Ryan_Project2NativeItemTextField = -9,
	UIBacka_Ryan_Project2NativeItemSearchBar = -10,
	
	UIBacka_Ryan_Project2NativeItemPicker = -11,
	UIBacka_Ryan_Project2NativeItemDatePicker = -12,
	
	UIBacka_Ryan_Project2NativeItemInfoLight = -13,
	UIBacka_Ryan_Project2NativeItemInfoDark = -14,
	
	UIBacka_Ryan_Project2NativeItemDisclosure = -15,
	
	UIBacka_Ryan_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Backa_Ryan_Project2 instances of
