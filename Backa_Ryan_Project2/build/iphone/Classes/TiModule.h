...
/**
 The base class for all Backa_Ryan_Project2 modules
 */
...
/**
 Backa_Ryan_Project2 Platform calls this method on startup.
 */
-(void)startup;

/**
 Backa_Ryan_Project2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Backa_Ryan_Project2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Backa_Ryan_Project2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Backa_Ryan_Project2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
