...
@interface Backa_Ryan_Project2Object : KrollCoverageObject {
#else
@interface Backa_Ryan_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Backa_Ryan_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Backa_Ryan_Project2Object *_backa_ryan_project2;
    KrollObject* console;
	BOOL shutdown;
