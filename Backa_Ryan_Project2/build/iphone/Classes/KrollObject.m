...
//@interface Backa_Ryan_Project2Object : NSObject
//@end

@interface Backa_Ryan_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Backa_Ryan_Project2Object class]])
		{
			for (NSString *key in [[(Backa_Ryan_Project2Object*)o modules] allKeys])
			{
