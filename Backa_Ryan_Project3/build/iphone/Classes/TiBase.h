...
// in simulator we redefine to format for Backa_Ryan_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.backa_ryan_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.backa_ryan_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBacka_Ryan_Project3NativeItemNone = -1, 
	UIBacka_Ryan_Project3NativeItemSpinner = -2,
	UIBacka_Ryan_Project3NativeItemProgressBar = -3,
	
	UIBacka_Ryan_Project3NativeItemSlider = -4,
	UIBacka_Ryan_Project3NativeItemSwitch = -5,
	UIBacka_Ryan_Project3NativeItemMultiButton = -6,
	UIBacka_Ryan_Project3NativeItemSegmented = -7,
	
	UIBacka_Ryan_Project3NativeItemTextView = -8,
	UIBacka_Ryan_Project3NativeItemTextField = -9,
	UIBacka_Ryan_Project3NativeItemSearchBar = -10,
	
	UIBacka_Ryan_Project3NativeItemPicker = -11,
	UIBacka_Ryan_Project3NativeItemDatePicker = -12,
	
	UIBacka_Ryan_Project3NativeItemInfoLight = -13,
	UIBacka_Ryan_Project3NativeItemInfoDark = -14,
	
	UIBacka_Ryan_Project3NativeItemDisclosure = -15,
	
	UIBacka_Ryan_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Backa_Ryan_Project3 instances of
