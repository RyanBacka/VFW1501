...
@interface Backa_Ryan_Project3Object : KrollCoverageObject {
#else
@interface Backa_Ryan_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Backa_Ryan_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Backa_Ryan_Project3Object *_backa_ryan_project3;
    KrollObject* console;
	BOOL shutdown;
