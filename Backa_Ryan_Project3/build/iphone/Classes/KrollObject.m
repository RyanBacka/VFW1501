...
//@interface Backa_Ryan_Project3Object : NSObject
//@end

@interface Backa_Ryan_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Backa_Ryan_Project3Object class]])
		{
			for (NSString *key in [[(Backa_Ryan_Project3Object*)o modules] allKeys])
			{
