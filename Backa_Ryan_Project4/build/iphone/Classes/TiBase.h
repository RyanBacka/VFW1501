...
// in simulator we redefine to format for Backa_Ryan_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.backa_ryan_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.backa_ryan_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBacka_Ryan_Project4NativeItemNone = -1, 
	UIBacka_Ryan_Project4NativeItemSpinner = -2,
	UIBacka_Ryan_Project4NativeItemProgressBar = -3,
	
	UIBacka_Ryan_Project4NativeItemSlider = -4,
	UIBacka_Ryan_Project4NativeItemSwitch = -5,
	UIBacka_Ryan_Project4NativeItemMultiButton = -6,
	UIBacka_Ryan_Project4NativeItemSegmented = -7,
	
	UIBacka_Ryan_Project4NativeItemTextView = -8,
	UIBacka_Ryan_Project4NativeItemTextField = -9,
	UIBacka_Ryan_Project4NativeItemSearchBar = -10,
	
	UIBacka_Ryan_Project4NativeItemPicker = -11,
	UIBacka_Ryan_Project4NativeItemDatePicker = -12,
	
	UIBacka_Ryan_Project4NativeItemInfoLight = -13,
	UIBacka_Ryan_Project4NativeItemInfoDark = -14,
	
	UIBacka_Ryan_Project4NativeItemDisclosure = -15,
	
	UIBacka_Ryan_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Backa_Ryan_Project4 instances of
