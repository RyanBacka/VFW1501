...
//@interface Backa_Ryan_Project4Object : NSObject
//@end

@interface Backa_Ryan_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Backa_Ryan_Project4Object class]])
		{
			for (NSString *key in [[(Backa_Ryan_Project4Object*)o modules] allKeys])
			{
