...
@interface Backa_Ryan_Project4Object : KrollCoverageObject {
#else
@interface Backa_Ryan_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Backa_Ryan_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Backa_Ryan_Project4Object *_backa_ryan_project4;
    KrollObject* console;
	BOOL shutdown;
