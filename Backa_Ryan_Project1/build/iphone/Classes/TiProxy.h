...
//Rare exceptions to indicate a bug in the _backa_ryan_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Backa_Ryan_Project1 proxies.
 */
