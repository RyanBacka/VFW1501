...
// in simulator we redefine to format for Backa_Ryan_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.backa_ryan_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.backa_ryan_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBacka_Ryan_Project1NativeItemNone = -1, 
	UIBacka_Ryan_Project1NativeItemSpinner = -2,
	UIBacka_Ryan_Project1NativeItemProgressBar = -3,
	
	UIBacka_Ryan_Project1NativeItemSlider = -4,
	UIBacka_Ryan_Project1NativeItemSwitch = -5,
	UIBacka_Ryan_Project1NativeItemMultiButton = -6,
	UIBacka_Ryan_Project1NativeItemSegmented = -7,
	
	UIBacka_Ryan_Project1NativeItemTextView = -8,
	UIBacka_Ryan_Project1NativeItemTextField = -9,
	UIBacka_Ryan_Project1NativeItemSearchBar = -10,
	
	UIBacka_Ryan_Project1NativeItemPicker = -11,
	UIBacka_Ryan_Project1NativeItemDatePicker = -12,
	
	UIBacka_Ryan_Project1NativeItemInfoLight = -13,
	UIBacka_Ryan_Project1NativeItemInfoDark = -14,
	
	UIBacka_Ryan_Project1NativeItemDisclosure = -15,
	
	UIBacka_Ryan_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Backa_Ryan_Project1 instances of
