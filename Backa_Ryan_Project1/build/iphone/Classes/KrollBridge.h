...
@interface Backa_Ryan_Project1Object : KrollCoverageObject {
#else
@interface Backa_Ryan_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Backa_Ryan_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Backa_Ryan_Project1Object *_backa_ryan_project1;
    KrollObject* console;
	BOOL shutdown;
