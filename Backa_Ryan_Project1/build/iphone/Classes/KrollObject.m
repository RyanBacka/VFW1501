...
//@interface Backa_Ryan_Project1Object : NSObject
//@end

@interface Backa_Ryan_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Backa_Ryan_Project1Object class]])
		{
			for (NSString *key in [[(Backa_Ryan_Project1Object*)o modules] allKeys])
			{
